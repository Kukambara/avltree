...
class AvlTree<T extends Comparable<? super T>> {
    ...
    public void setNewElement(AvlNode node) {
        drawer.newElement = node;
        drawer.draw();
    }

    public void setRotatingElement(AvlNode node) {
        drawer.rotating = node;
        drawer.draw();
    }

    public void setAlgorithmInElement(AvlNode node) {
        drawer.algorithmElement = node;
        drawer.draw();
    }
